...
> [!NOTE]
> If you need training source to training your model with another app,[Click here](https://github.com/DuolaD/DaWei_So_Vits_svc_Model/releases/tag/Training_Source)  to download.
